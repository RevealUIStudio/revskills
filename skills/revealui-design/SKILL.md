...
If creating visual artifacts (slides, mocks, throwaway prototypes), create static HTML files for the user to view. Use token values from the design-context pack; do not copy ui_kits/ or assets/ from any local bundle — those are not part of this skill.

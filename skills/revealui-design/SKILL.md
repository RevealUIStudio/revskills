...
Type stack: Inter (sans), Inter Tight (display, 800 weight, -0.02em tracking), JetBrains Mono (mono, ligatures OFF).

Marketing signatures:
- Receipt motif + foil: "If an agent did it, there's a receipt."
